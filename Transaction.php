...
<form action="withdraw.php" method="post"
  <div >
    ...
    <label for="withd"><b>Wthdraw</b></label>
    <input type="text" placeholder="Enter Amount" name="withd"  >

    <button type="submit" name="With" value="With">Withdraw</button>
...
<form action="deposit.php" method="post">
  <div >
    ...
    <input type="text" placeholder="Enter Amount" name="deposit"  >
