...
<form action="../pages/signup.php" method="post">
  <div >
    ...
    <input type="text" placeholder="Enter Employee ID" name="e_id">

    <label for="e_name"><b>Employee Name</b></label>
    <input type="text" placeholder="Enter Employee name" name="e_name">
